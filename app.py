...
from KeyTakeaway.ext import lexrank
from KeyTakeaway.preprocess_test import preprocess_sum
...
def upload():
    if request.method == "POST":
        ...
        # newInput = get_summary(f'KeyTakeaway/clean_{base_filename}{i}.txt')
